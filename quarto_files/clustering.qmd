...
<!-- * compare and contrast the methods for clustering:

    * hierarchical vs. probabilistic vs overlapping vs. exclusive 

    * KMEANS, DBSCAN, Hierarchy, Density, etc...

* prepare the data

    * choose a labeled dataset and remove the label

        * **in my case - the label may be multiple items in the dataset, depending on prediction goals**

    * perform standard scaling

    * perform PCA on normalized data

    * provide screen images of before and after data? -->
