...
An example of a kernel function could be considered the cubic function.  A cube of the product of two vectors can be expressed as the dot product of two vectors as follows:

$(a^Tb)^3 = (a^Tb) (a^Tb) (a^Tb)$

$(a^Tb)^3 = (a_1b_1+a_2b_2) (a_1b_1+a_2b_2) (a_1b_1+a_2b_2)$

$(a^Tb)^3 = (a_1^2b_1^2+ 2a_1a_2b_1b_2 + a_2^2b_2^2) (a_1b_1+a_2b_2)$

$(a^Tb)^3 = a_1^3b_1^3 + a_1^2b_1^2a_2b_2 + 2a_1^2b_1^2a_2b_2 + 2a_2^2b_2^2a_1b_1 + a_2^2b_2^2a_1b_1 + a_2^3b_2^3$  

$(a^Tb)^3 = a_1^3b_1^3 + 3a_1^2b_1^2a_2b_2 + 3a_2^2b_2^2a_1b_1+a_2^3b_2^3$

$(a^Tb)^3 = [a_1^3,\sqrt{3}a_1^2a_2,\sqrt{3}a_2^2a_1,a_2^3]^\text{T} \cdot [b_1^3,\sqrt{3}b_1^2b_2,\sqrt{3}b_2^2b_1,b_2^3]$ 

Where $[a_1^3,\sqrt{3}a_1^2a_2,\sqrt{3}a_2^2a_1,a_2^3]$ signifies the transformation of a 2d point $a=(x_1,y_1)$ and $[b_1^3,\sqrt{3}b_1^2b_2,\sqrt{3}b_2^2b_1,b_2^3]$ signfies the transformation of a 2d point $b=(x_2,y_2)$

As such, this cubic function can be used to project a point (x,y) from 2d to 4d space.  Let's take the 2d point $a=(2,3)$:

$\text{transformation of a}= [a_1^3,\sqrt{3}a_1^2a_2,\sqrt{3}a_2^2a_1,a_2^3]$

$\text{transformation of a}=[-2^3,\sqrt{3}(-2)^2\cdot -3, \sqrt{3}(-3)^2\cdot -2, (-3)^3]$

$\text{transformation of a}=[-8,\sqrt{3}\cdot 4\cdot -3, \sqrt{3}\cdot 9 \cdot -2, -27]$

$\text{transformation of a}=[-8,-12\sqrt{3}, -18\sqrt{3}, -27]$

This provides the transformation of a to 4 dimensions.
