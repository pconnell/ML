...
```{python mca-col-conts1}
#| label: mca-col-conts1
...
```{python mca-col-conts2}
#| label: mca-col-conts2
...
```{python mca-col-conts3}
#| label: mca-col-conts3
...
```{python mca-npc-col-conts1}
#| label: mca-npc-col-conts1
...
```{python mca-npc-col-conts2}
#| label: mca-npc-col-conts2
...
```{python mca-npc-col-conts3}
#| label: mca-npc-col-conts3
