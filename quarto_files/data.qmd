...
The source code for data gathering efforts in this research is located [here](../src/pull_data.py). 
...
axes[1].set_ylabel('')
plt.suptitle("Logarithmic Kernel Density Estimate \nfor Applicant Income")
plt.tight_layout()
plt.show()
```
...
g = sns.FacetGrid(data=dat,col='Race')
g.fig.set_figheight(4)
g.map_dataframe(
    sns.barplot,x='approval',y='company',hue='company'
)
